...
function displayStudentInfo(objUser){
    let arrUser = Object.entries(objUser)
    console.log(`Your full name is ${arrUser[0][1]} ${arrUser[1][1]}`);
}
...
usersArr = usersArr.map((user)=>[user[0], user[1]*2])
console.log(usersArr);
...
class Mamal extends Animal {
    ...
    sound(noise) {
        console.log(`Hi! My name is ${this.name}, I am a ${this.color} ${this.type}. :) ${noise}`);
    }
}
...
let farmerCow = new Mamal("Bob", "cow", "purple")
farmerCow.sound("Moooooooooooooooo")
